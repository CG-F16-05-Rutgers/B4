...
public class NavCharScript : MonoBehaviour
{
    ...
    void Update()
    {
                        ...
                        for (int i = 0; i < active.Count; i++)
                        {
                            ...
                            if (moving.Count > 0)
                            {
                                ...
                                if (c)
                                {
                                    ...
                                    active[i].GetComponent<Animator>().SetBool("Moving", true);
                                }
                            }
                            else
                            {
        ...
        for(int i = 0; i < active.Count; i++)
                        {
            if (active[i].GetComponent<NavMeshAgent>().isOnOffMeshLink)
            {
                active[i].GetComponent<Animator>().SetBool("Jump", true);
            }
            else
            {
                active[i].GetComponent<Animator>().SetBool("Jump", false);
            }
        }
                ...
                for (int k = 0; k < stop.Count; k++)
                {
                    ...
                    for (int n = 0; n < moving.Count; n++)
                    {
                        if (moving[n].gameObject == stop[k].gameObject)
                        {
                            ...
                            active[n].GetComponent<Animator>().SetBool("Moving", false);
                            break;
                        }
                    }
                }
